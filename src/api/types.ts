// General API call results
export interface ApiResult {
  batchcomplete?: string
  success?: number
}

// MediaWiki API call results
export interface MWApiResult extends ApiResult {
  query?: QueryResult
}

// Wikibase Call Results
...
// General key-value list with string values as keys, essentially a dictionary
...
// General key-value list with number values as keys
...
export interface TermResult { // language value pair
  language: string
  value: string
}

export type ClaimType = 'statement'
export type Rank = 'normal' | 'preferred' | 'deprecated' | 'best'
